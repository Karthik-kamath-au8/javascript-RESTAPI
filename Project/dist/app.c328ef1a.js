...
function renderHTML(worldFlags) {
  var _iterator = _createForOfIteratorHelper(worldFlags),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var flag = _step.value;
      var flagHTML = "<div class=\"container_flag container_flag--1\">\n    <img class =\"container_flag-image\" \n    src=".concat(flag.image, ">\n    <p class=\"container_flag-name\"><span>Name:</span>").concat(flag.name, "</p>\n    <p class=\"container_flag-capital\"><span>Capital:</span>").concat(flag.capital, "</p>\n    <p class=\"container_flag-borders\"><span>Borders:</span>").concat(flag.borders, "</p>\n    </div> ");
...
function fetchWorldAtlas() {
  ...
  var worldPromise = _axios.default.get("".concat(baseURL, "all")).then(function (response) {
    var constructedData = [];
    var worldFlags = response.data;

    var _iterator2 = _createForOfIteratorHelper(worldFlags),
        _step2;
...
function renderIndiHTML(flag) {
  var _iterator3 = _createForOfIteratorHelper(flag),
      _step3;

  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var flag = _step3.value;
      var indiHTML = "\n    <div class=\"flag_flag-details\">\n    <img class =\"container_flag-image\" \n    src=".concat(flag.flag, ">\n    <p class=\"container_flag-name\"><span>Name:</span>").concat(flag.name, "</p>\n    <p class=\"container_flag-capital\"><span>Capital:</span>").concat(flag.capital, "</p>\n    <p class=\"container_flag-borders\"><span>Borders:</span>").concat(flag.borders, "</p>\n    </div>");
...
function fetchWorldSIngleFlag(flagName) {
  ...
  return fetch("".concat(baseURL, "name/").concat(flagName)).then(function (response) {
...
worldCardContainer.addEventListener("click", function () {
  var isCardClicked = event.target.matches(".container_flag, .container_flag *");

  if (isCardClicked) {
    var containerCard = event.target.closest(".container_flag");
    var flagName = containerCard.querySelector(".container_flag-name").textContent.replace("Name:", "");
