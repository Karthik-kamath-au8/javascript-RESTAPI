...
function renderHTML(api_response) {
  ...
  var _iterator = _createForOfIteratorHelper(api_response.results),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var vehicle = _step.value;
      vehicleHTML += "<div class=\"container_vehicle container_vehicle-1\" data-url=".concat(vehicle.url, ">\n        <p class=\"container_vehicle-name\"><span>Name:</span>").concat(vehicle.name, "</p>\n        <p class=\"container_vehicle-model\"><span>Model:</span>").concat(vehicle.model, "</p>\n        <p class=\"container_vehicle-manufacturer\"><span>Manufacturer:</span>").concat(vehicle.manufacturer, "</p>\n    </div>"); //vechConatiner.insertAdjacentHTML("beforeend", vehicleHTML);
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
function fetchSwVehicles(url) {
  ...
  var newPromise = _axios.default.get("".concat(url)).then(function (response) {
...
function renderIndiHTML(vec) {
  var vecHTML = " <div class=\"vehicles_container\">\n  <p class=\"container_vehicle-name\"><span>Name:</span>".concat(vec.name, "</p>\n        <p class=\"container_vehicle-model\"><span>Model:</span>").concat(vec.model, "</p>\n        <p class=\"container_vehicle-manufacturer\"><span>Manufacturer:</span>").concat(vec.manufacturer, "</p>\n        <p class=\"container_vehicle-passengers\"><span>Passengers:</span>").concat(vec.passengers, "</p>\n        <p class=\"container_vehicle-crew\"><span>Crew:</span>").concat(vec.crew, "</p>\n        <p class=\"container_vehicle-films\"><span>flims:</span>").concat(vec.films, "</p>\n        \n        <div class=\"vehicle_detail-data\">\n        <div class=\"vechiles_container\"></div>\n        <button class=\"vehicle_conatiner-fav\" style=\"color: rgb(235,47,6);background:transparent;\">\n        <i class=\"fa fa-heart\">\n        </i> Add to Fav</button></div>\n        </div>\n  \n        ");
...
function fetchSwSingleVec(vehicleName) {
  ...
  return fetch("".concat(vehicleName)).then(function (response) {
...
vechConatiner.addEventListener("click", function () {
  var isCardClicked = event.target.matches(".container_vehicle, .container_vehicle *");
